...
class detailSphere: UIViewController {
    ...
    func getSphereTables() {
        let request = NSMutableURLRequest(URL: NSURL(string: "https://bossinvaderapi-guimeus.c9users.io/serveur/Tables/tableSphereInfo.php")!)
    ...
    func recoit() {
        ...
        let request = NSMutableURLRequest(URL: NSURL(string: "https://bossinvaderapi-guimeus.c9users.io/serveur/Tables/joinTableSphere.php")!)
        let json: [String: AnyObject] = [
            "Createur": mail.text!,
