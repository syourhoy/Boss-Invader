...
class Sphere: UIViewController {
    ...
    func envoi() {
        ...
        let strDate = formatter.stringFromDate(datepick.date)
        let request = NSMutableURLRequest(URL: NSURL(string: "https://bossinvaderapi-guimeus.c9users.io/serveur/Tables/createTableSphere.php")!)
        print("1")
