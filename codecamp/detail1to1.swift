...
//  codecamp
//
//  Created by Samir ABOU BEKR on 20/04/16.
//  Copyright © 2016 Samir ABOU BEKR. All rights reserved.
//

import UIKit

class detail1to1: UIViewController {
    ...
    func get1to1Tables() {
        let request = NSMutableURLRequest(URL: NSURL(string: "https://bossinvaderapi-guimeus.c9users.io/serveur/Tables/table1to1Info.php")!)
    ...
    func recoit() {
        let request = NSMutableURLRequest(URL: NSURL(string: "https://bossinvaderapi-guimeus.c9users.io/serveur/Tables/joinTable1to1.php")!)
        let json: [String: AnyObject] = [
            "Createur": mail.text!,
        ...
        let loginAction = UIAlertAction(title:"ok",
                                        style:UIAlertActionStyle.Default) { (UIAlertAction) -> Void in
                                            ...
                                            // for example:
                                            self.performSegueWithIdentifier("toHome3", sender:self)
        }
